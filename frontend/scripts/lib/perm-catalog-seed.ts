...
export const PERM_PAGES: PermPage[] = [
  ...
  {
    permModule: "admin",
    type: "website_country",
    resource: "/api/v1/website/countries",
  },
  {
    permModule: "admin",
    type: "website_province",
    resource: "/api/v1/website/provinces",
  },
  {
    permModule: "admin",
    type: "website_district",
    resource: "/api/v1/website/districts",
  },
  {
    permModule: "admin",
    type: "website_sub_district",
    resource: "/api/v1/website/sub-districts",
  },
