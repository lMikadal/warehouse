...
- [x] Write setting module (12 files): vat, sale_channel+language, bank+language, payment_method+language, code, claim_reason+language, prefix+language
...
- [x] `make design-schema-check` exits 0 (86 files, all rules green)
...
- [x] `supplier_information`, `supplier_contact`, `supplier_bank` restored (v2 had none)
