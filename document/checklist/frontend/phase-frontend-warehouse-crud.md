...
- [x] `loading.tsx` on list + view segments ([`warehouse-view-page-skeleton.tsx`](../../../frontend/app/[locale]/(admin)/admin/(backoffice)/warehouse/_shared/warehouse-view-page-skeleton.tsx) for view route + in-page fetch)
