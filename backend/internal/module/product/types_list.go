...
type ItemListFilter struct {
	...
	// Refill drives the จัดซื้อ refill tab: "low_stock" (on hand under the reorder point),
	// "is_stop" (discontinued), "ordered" (already on an open purchase order). "" / "all" = no filter.
	Refill string
}
