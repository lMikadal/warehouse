...
CREATE TYPE product_attribute_relation_discount_type AS ENUM ('percent', 'baht');
...
CREATE TABLE product_attribute_relation (
    ...
    discount_type         product_attribute_relation_discount_type    NOT NULL DEFAULT 'percent', -- percent | baht
