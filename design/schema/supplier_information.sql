...
--   - renamed: supplier_address → supplier_information; type main/invoice/address → contact/tax_invoice/delivery
--   - PK: (supplier_user_id, type) — one row per type per supplier
...
CREATE TABLE supplier_information (
    ...
    type                     supplier_information_type   NOT NULL,                 -- contact, tax_invoice, or delivery
    ...
    is_same_information      BOOLEAN                     NOT NULL DEFAULT FALSE,    -- tax_invoice copies contact row
