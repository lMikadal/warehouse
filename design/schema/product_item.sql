...
--   - restored: barcode, qrcode, weight/width/length/height (dimensions), minimum_stock, new_product_item_id, is_stopped
...
CREATE TABLE product_item (
    ...
    new_product_item_id   BIGINT                  REFERENCES product_item(id) ON DELETE SET NULL,  -- replacement item
