...
--   - derived (not stored): empty slots = count child warehouse_list rows of this type
...
CREATE TABLE warehouse_condition (
    ...
    type               warehouse_list_type NOT NULL,  -- child node type this quota row applies to
