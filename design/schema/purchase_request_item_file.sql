-- source: v1 order_ticket_items.image_url[] → normalized via system_file
...
--   - purpose on system_file: 'purchase_request_item_image'
...
CREATE UNIQUE INDEX uq_purchase_request_item_file_item_file
    ON purchase_request_item_file (purchase_request_item_id, system_file_id)
...
CREATE INDEX idx_purchase_request_item_file_file
    ON purchase_request_item_file (system_file_id);
