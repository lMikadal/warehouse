...
--   - image_url → website_file_id (purpose: setting_bank_logo)
CREATE TABLE setting_bank (
    id          BIGSERIAL    PRIMARY KEY,              -- surrogate PK
    website_file_id BIGINT       REFERENCES website_file(id) ON DELETE RESTRICT, -- bank logo (purpose: setting_bank_logo)
...
CREATE INDEX idx_setting_bank_file        ON setting_bank (website_file_id) WHERE website_file_id IS NOT NULL;
