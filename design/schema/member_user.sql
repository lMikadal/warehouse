...
--   - image_url → website_file_id (purpose: member_avatar); documents stay in member_file
...
CREATE INDEX idx_member_user_file               ON member_user (website_file_id) WHERE website_file_id IS NOT NULL;
