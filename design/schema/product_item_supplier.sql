...
CREATE TABLE product_item_supplier (
    ...
    supplier_supplier_id BIGINT        NOT NULL REFERENCES supplier_supplier(id)  ON DELETE RESTRICT, -- supplier
...
CREATE UNIQUE INDEX uq_product_item_supplier_item_supplier
    ON product_item_supplier (product_item_id, supplier_supplier_id);

CREATE INDEX idx_product_item_supplier_item       ON product_item_supplier (product_item_id);
CREATE INDEX idx_product_item_supplier_supplier   ON product_item_supplier (supplier_supplier_id);
