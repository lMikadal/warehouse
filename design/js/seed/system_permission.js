(function (global) {
  ...
  var PERM_PAGES = [
    ...
    { permModule: "admin", type: "system_country", resource: "/api/v1/system/countries" },
    { permModule: "admin", type: "system_province", resource: "/api/v1/system/provinces" },
    { permModule: "admin", type: "system_district", resource: "/api/v1/system/districts" },
    { permModule: "admin", type: "system_sub_district", resource: "/api/v1/system/sub-districts" },
